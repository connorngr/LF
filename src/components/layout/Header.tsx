...
export default function Header({
  ...
  return (
    <div className="flex items-center justify-between gap-4 mb-8 sticky top-0 bg-background z-10 py-5 w-full">
      ...
      <div className="flex items-center gap-4 sm:gap-8 flex-1 sm:flex-none">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full bg-surface text-foreground pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-sm sm:text-base"
          />
        </div>
      </div>
    </div>
